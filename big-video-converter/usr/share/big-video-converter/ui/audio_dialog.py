...
class AudioDialog(Adw.Dialog):
    ...
    def __init__(self, app):
        ...
        # The native adaptive presentation follows the available parent area.
        ...
        # Do not compound caption + dim-label + opacity: this is essential
        # output information, not ornamental metadata.
